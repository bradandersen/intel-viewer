...
competitors_list = [
    ...
    ('Code42', 'Code42 (Incydr OR "insider risk") -jobs'),
    ('BigID', 'BigID ("data security" OR DSPM OR privacy) -jobs'),
    ('Wiz', 'Wiz.io ("cloud security" OR DSPM) -jobs'),
    ('Securiti.ai', 'Securiti.ai (DSPM OR privacy) -jobs'),
    ('Sentra', 'Sentra (DSPM OR "data security") -jobs'),
    ('Netskope', 'Netskope (DLP OR CASB OR SASE) -jobs -stock'),
    ('Zscaler', 'Zscaler (DLP OR "data security") -jobs -stock'),
    ('Microsoft Purview', '"Microsoft Purview" (DLP OR "data loss prevention") -jobs'),
    ('Lakera', 'Lakera ("AI security" OR "GenAI" OR "LLM security") -jobs'),
    ('Polar Security', '"Polar Security" (DSPM OR "data security") -jobs'),
    ('Symantec DLP', '("Symantec DLP" OR "Broadcom DLP") -jobs'),
    ('Skyhigh Security', '"Skyhigh Security" (CASB OR DLP) -jobs'),
    ('CrowdStrike', 'CrowdStrike ("data protection" OR DLP OR "Falcon Data Protection") -jobs -stock'),
    ('SentinelOne', 'SentinelOne ("data control" OR DLP OR "data protection") -jobs -stock'),
    ('SquareX', 'SquareX ("browser security" OR DLP OR "browser DLP") -jobs'),
    ('Island', 'Island ("enterprise browser" OR "browser security" OR DLP) -jobs -island.io'),
    ('Talon/Palo Alto', '("Talon Cyber" OR "Prisma Access Browser") ("browser security" OR DLP) -jobs'),
    ('LayerX Security', '"LayerX Security" ("browser security" OR DLP OR "AI security") -jobs'),
    ('Seraphic Security', '"Seraphic Security" ("browser security" OR DLP) -jobs'),
    ('Surf Security', '"Surf Security" ("browser" OR DLP OR SASE) -jobs'),
    ('Menlo Security', '"Menlo Security" ("browser isolation" OR DLP OR RBI) -jobs'),
]
