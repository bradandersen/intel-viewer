...
competitors_list = [
    ...
    ('Wiz', 'Wiz ("cloud security" OR DSPM) -jobs'),
    ('Lacework', 'Lacework ("cloud security" OR DSPM) -jobs'),
    ('Orca Security', '"Orca Security" ("cloud security" OR DSPM) -jobs'),
    ('CrowdStrike', 'CrowdStrike (EDR OR "endpoint security" OR DLP) -jobs'),
    ('SentinelOne', 'SentinelOne (EDR OR "endpoint security" OR DLP) -jobs'),
    ('Code42', 'Code42 (EDR OR "endpoint security" OR DLP) -jobs'),
    ...
    ('Lakera', 'Lakera ("AI security" OR "LLM security") -jobs'),
    ('Veza', 'Veza (security) -jobs'),
    ('Microsoft Purview', '"Microsoft Purview" (security) -jobs'),
]
