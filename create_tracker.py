...
competitors = [
    ...
    ["DTEX", "DLP", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.dtex.com", datetime.now().strftime('%Y-%m-%d')],
    ...
    ["Microsoft Purview", "DLP/DSPM", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.microsoftpurview.com", datetime.now().strftime('%Y-%m-%d')],
    ...
    ["Defensx", "Browser Security", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.defensx.com", datetime.now().strftime('%Y-%m-%d')],
    ["Ermes", "Browser Security", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.ermes.com", datetime.now().strftime('%Y-%m-%d')],
    ...
    ["Perception Point", "Browser Security", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.perceptionpoint.com", datetime.now().strftime('%Y-%m-%d')],
    ["Redaccess", "Browser Security", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.redaccess.com", datetime.now().strftime('%Y-%m-%d')],
    ...
    ["Automation Anywhere", "Workflow/BPM", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.automationanywhere.com", datetime.now().strftime('%Y-%m-%d')],
    ["UiPath", "Workflow/BPM", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.uipath.com", datetime.now().strftime('%Y-%m-%d')],
    ["Blue Prism", "Workflow/BPM", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.blueprism.com", datetime.now().strftime('%Y-%m-%d')],
    ["Microsoft Power Automate", "Workflow/BPM", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "TBD", "Cloud SaaS", "TBD", "TBD", "https://www.microsoftpowerautomate.com", datetime.now().strftime('%Y-%m-%d')],
