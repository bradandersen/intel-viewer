...
# Competitor data
competitors = [
    ["Nightfall AI", "DLP/Shadow AI", "2016", "San Francisco, CA", "Series C", "$63M", "Series C", "2022", "~$200M", "100-200",
     "Cloud DLP for SaaS/AI", "Cloud SaaS", "Shadow AI detection, GenAI data leakage, Sensitive data discovery, Nyx autonomous analyst",
     "AI-native DLP, Shadow AI focus, Nyx autonomous investigation, 100+ SaaS integrations", "https://www.nightfall.ai", datetime.now().strftime("%Y-%m-%d")],
